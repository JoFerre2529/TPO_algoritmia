...
#TOTAL DE FACTURACIÓN POR CADA TIPO DE VEHICULO
...
#TOTAL DE COSTO POR CADA TIPO DE VEHICULO
...
def calcular_costo_total():
    ...
    #print(f"costo_total sin redondear: {costo_total}")
    redondeado = round(costo_total,2)
    #print(f"costo_total  redondeaad: {redondeado}")
    return redondeado



def ordenar(lista_facturacion, lista_km, lista_tipos):
...
def punto_1():
        print("\n")
        print("FACTURACION TOTAL DEL MES :   $", calcular_facturacion_total())
        print("\n")
        print("COSTO DE MANTENIMIENTO TOTAL :   $", calcular_costo_total())
        print("\n")
        print("CANTIDAD DE VEHICULOS : ", cantidad_vehiculos(), "Unidades")
        print("\n")
...
def punto_2():
    ...
    ordenar(factuarion_por_tipo, km_por_tipo, tipo_vehiculos)

    print(tipo_vehiculos)
    print(factuarion_por_tipo)
    print(km_por_tipo)

    for i in range(len(tipo_vehiculos)):
        print("Tipo vehiculo: ", tipo_vehiculos[i])
        print("Facturacion: ", factuarion_por_tipo[i])
        print("Cantidad KM: ", km_por_tipo[i])
        print()


# Poder seleccionar un tipo de vehículo 
# y que se detallen 
# la facturación, 
# la cantidad de clientes 
# y el costo del tipo de vehículo seleccionado.
...
def punto_4():
    ...
    costo = COSTOS_MANTENIMIENTO[num_tipo - 1]
