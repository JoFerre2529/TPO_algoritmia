...
def generar_facturacion(tipoDevehiculo, km_recorridos):
    costo_mantenimiento = COSTOS_MANTENIMIENTO[tipoDevehiculo]
    precio_1000 = PRECIO_FIJO_HASTA_1000KM[tipoDevehiculo]
